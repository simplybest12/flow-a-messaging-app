...
class _MessageCardState extends State<MessageCard> {
  ...
  Widget build(BuildContext context) {
    bool isMe = CloudFirestore.user.uid == widget.message.fromId;
    return InkWell(
            ...
            children: [
              ...
              if (isMe)
                _OptionItem(
                    ...
                    name: 'Delete Message',
                    onTap: () async {
                      await CloudFirestore.deleteMessage(widget.message)
                          .then((value) {
                        //for hiding bottom sheet
                        Navigator.pop(context);
                      });
              ...
              actions: [
                ...
                MaterialButton(
                    onPressed: () {
                      //hide alert dialog
                      Navigator.pop(context);
                      CloudFirestore.updateMessage(widget.message, updatedMsg);
                    },
                    child: const Text(
                      'Update',
                      style: TextStyle(color: Colors.blue, fontSize: 16),
